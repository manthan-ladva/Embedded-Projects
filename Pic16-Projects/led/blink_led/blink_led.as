...
; *************** function _main *****************
; Defined at:
;		line 5 in file "C:\Users\Prolific\Desktop\Manthan Ladva\Pic16-Projects\led\blink_led\blink_led.c"
...
; 
psect	maintext
	file	"C:\Users\Prolific\Desktop\Manthan Ladva\Pic16-Projects\led\blink_led\blink_led.c"
	line	5
...
; *************** function _delay *****************
; Defined at:
;		line 18 in file "C:\Users\Prolific\Desktop\Manthan Ladva\Pic16-Projects\led\blink_led\blink_led.c"
; Parameters:    Size  Location     Type
...
;blink_led.c: 18: void delay(unsigned int k){
...
l30000341:	
;blink_led.c: 19: unsigned int i,j;
;blink_led.c: 20: for(i=0;i<k;i++) for(j=0;j<40;j++);
	movlw	low(0)
	movwf	(delay@i)
	movlw	high(0)
	movwf	((delay@i))+1
